...
import com.jtech.cloudtorrentmaster.net.sse.SSEHeaders;
import com.jtech.cloudtorrentmaster.net.sse.exceptions.ConnectionRefusedException;
...
public class EventSourceImpl implements EventSource {
    ...
    @Override
    public EventSource connect(Handler<AsyncResult<Void>> handler) {
